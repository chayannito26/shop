const bn = {
  ...
  home: {
    hero: {
      ...
      tagline:
        'আপনার ব্যাচের গর্ব প্রকাশ করুন! চয়ান্নিতো ২৬ এর জন্য উচ্চমানের মার্চেন্ডাইজ।',
    },
    sections: {
      products: {
        title: 'আমাদের পণ্যসমূহ',
        subtitle:
          'শুধুমাত্র চয়ান্নিতো ২৬ এর জন্য ডিজাইনকৃত প্রিমিয়াম পণ্যসমূহ আবিষ্কার করুন',
      },
    },
    filter: {
      all: 'সব',
  ...
  product: {
    ...
    phoneModel: {
      label: 'ফোন মডেল:',
      placeholder: 'যেমন: iPhone 12, Samsung Galaxy A12',
    ...
    addedToCart: 'পণ্য সফলভাবে কার্টে যোগ হয়েছে!',
    validation: {
      selectVariation: 'দয়া করে সাইজ/ভ্যারিয়েশন নির্বাচন করুন',
      enterPhoneModel: 'দয়া করে আপনার ফোন মডেল লিখুন (যেমন: iPhone 12, Samsung A12)',
    },
  },
  cart: {
    title: 'শপিং কার্ট',
    empty: {
      ...
      subtitle: 'চয়ান্নিতো ২৬ এর দারুণ পণ্যগুলো যোগ করুন!',
  ...
  checkout: {
    ...
    payment: {
      title: 'বিকাশ পেমেন্ট নির্দেশনা',
      step1: 'ধাপ ১:',
      step1Text: 'Send money করুন: {number}',
      step2: 'ধাপ ২:',
      step2Text: 'টাকা: ৳{amount}',
      step3: 'ধাপ ৩:',
      step3Text:
        'বিকাশ থেকে ট্রানজ্যাকশন আইডি কপি করে নিচে পেস্ট করুন',
      step4: 'ধাপ ৪:',
      step4Text: 'ফর্মটি সম্পূর্ণ করুন',
    },
    bkash: {
    ...
    note: {
      ...
      express:
        'এক্সপ্রেস অর্ডার: এটি সরাসরি ক্রয় — কার্টের আইটেমগুলো প্রভাবিত হবে না।',
    },
    validation: {
  ...
  coupon: {
    ...
    expiresIn: 'মেয়াদ শেষ হবে {time} পর',
    errors: {
      ...
      usageLimit: 'এই কুপনের ব্যবহারসীমা পূর্ণ হয়েছে।',
      minOrder: 'এই কুপনের জন্য ন্যূনতম অর্ডার হতে হবে ৳{min}।',
      fetchError: 'কুপন যাচাই করা যায়নি। পরে আবার চেষ্টা করুন।',
    },
